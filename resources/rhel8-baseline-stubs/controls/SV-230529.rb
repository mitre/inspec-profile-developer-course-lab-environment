...
taken."
  desc "check", "Verify RHEL 8 is not configured to reboot the system when Ctrl-Alt-Delete is pressed with the 
following command:
...
is loaded and not masked, this is a finding."
