...
Note: If IPv4 is disabled on the 
system, this requirement is Not Applicable.

Check the value of the accept source route 
...
$ sudo grep -r net.ipv4.conf.all.accept_source_route 
...
If 
\"net.ipv4.conf.all.accept_source_route\" is not set to \"0\", is missing or commented out, 
this is a finding.
...
in a system configuration file, in the \"/etc/sysctl.d/\" 
directory:
